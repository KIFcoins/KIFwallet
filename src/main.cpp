...
#if defined(NDEBUG)
# error "KIF cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "KIF Signed Message:\n";
...
if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 100)
        {
            nSubsidy = 3000000 * COIN; // 300M (3M * 100) coins
        }
