...
git clone https://github.com/KIF/KIF.git
cd KIF
chmod +x linuxKIF.sh
./linuxKIF.sh --build
...
git clone https://github.com/KIF/KIF.git
cd KIF
chmod +x linuxKIF64.sh
./linux64KIF.sh --build

Options:
--reset: update dependencies, clone KIF repository
--force: if you are using other versions such as Debian version > 7

Example with options:
./linux64KIF.sh --reset --force --build

After successful build, KIFd can be found in KIF/src/
